...
class __TwigTemplate_05be8bbd05e5ef6a85ca656861901d365f690542368aeefbbf1dda39d4fa3e27 extends Twig_Template
{
        ...
        MailPoet.Ajax.post({
          ...
          if(data.id) {
            MailPoet.Notice.success(
              \"";
        // line 94
        echo twig_escape_filter($this->env, twig_escape_filter($this->env, $this->env->getExtension('MailPoet\Twig\I18n')->translate("Updated custom field “\"+data.name+\"“"), "js"), "html", null, true);
        echo "\"
            );
          } else {
            MailPoet.Notice.success(
              \"";
        // line 98
        echo twig_escape_filter($this->env, twig_escape_filter($this->env, $this->env->getExtension('MailPoet\Twig\I18n')->translate("Added custom field “\"+data.name+\"“"), "js"), "html", null, true);
        echo "\"
            );
          }
...
";
    ...
    {
        return new Twig_Source("", "form/templates/settings/field_form.hbs", "/home/d/dyachezy/tvoymirsporta.ru/public_html/wp-content/plugins/mailpoet/views/form/templates/settings/field_form.hbs");
    }
}
