...
class __TwigTemplate_245dcc65e379e40bba862ed13a3f5d661adbee372d754317c4e88da1e75722e4 extends Twig_Template
{
  ...
  <textarea placeholder=\"{{#if params.label_within}}{{ params.label }}{{#if params.required}} *{{/if}}{{/if}}\" disabled=\"disabled\" rows=\"{{#if params.lines}}{{ params.lines }}{{else}}1{{/if}}\">{{ params.text }}</textarea>
    ...
    {
        return new Twig_Source("", "form/templates/blocks/textarea.hbs", "/home/d/dyachezy/tvoymirsporta.ru/public_html/wp-content/plugins/mailpoet/views/form/templates/blocks/textarea.hbs");
    }
}
